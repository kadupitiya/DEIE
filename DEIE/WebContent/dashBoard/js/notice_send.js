				...
				function() {
					...
					var options = {
						...
						success : function(out) {
							...
							window.location = "/DEIE/dashBoard/SpecialNotices.html";
...
function serverCallForSPID() {
	...
	var formURL = "/DEIE/restRequest/dashBoard/getSpecialNoticeID";
	$
			.ajax({
				url : formURL,
				type : "POST",
...
function serverCallForSPIDList() {
	...
	var formURL = "/DEIE/restRequest/dashBoard/getSpecialNoticeIDList";
	$.ajax({
		url : formURL,
		type : "POST",
		data : postData,
...
function serverCallForSingleSPLoad(index) {
	var postData = {
		specialNoticeClick : index
	}
	var formURL = "/DEIE/restRequest/specialSingleNoticeLoad";
	$
			.ajax({
				url : formURL,
				type : "POST",
				...
				success : function(data, textStatus, jqXHR) {
					...
					var specialSingleNotice = data.selectedNotice;
